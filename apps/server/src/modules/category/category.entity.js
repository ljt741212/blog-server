...
(function (CategoryStatus) {
    CategoryStatus[CategoryStatus["DISABLED"] = 0] = "DISABLED";
    CategoryStatus[CategoryStatus["ENABLED"] = 1] = "ENABLED";
...
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 50, unique: true, comment: '分类名称' }),
